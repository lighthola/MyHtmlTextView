...
//  freemycard
//
//  Created by Ashbel on 9/14/15.
//  Copyright (c) 2015 Soft-World. All rights reserved.
//
...
-(BOOL)includesString:(NSString *)includedString {
    NSRange range = [self rangeOfString:includedString];
